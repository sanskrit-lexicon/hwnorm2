...
python3 keydoc1.py $dict $hwfile $multifile $keydoc1

# step 2
keydoc1x="$dir/keydoc1x.txt"
hwextra="distincthws/data/${dict}_hwextra.txt"
python3 keydoc1x.py $dict $keydoc1 $hwextra $keydoc1x

# step 3
keydocnorm="$dir/keydoc1x_norm.txt"
echo "Compute $keydocnorm"
python3 keydoc1x_norm.py $dict $keydoc1x $keydocnorm
...
python3 keydoc1x_norm1.py $dict $keydocnorm $multidir $keydocnorm1
